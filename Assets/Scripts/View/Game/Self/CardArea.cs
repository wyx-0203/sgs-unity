...
public class CardArea : SingletonMono<CardArea>
{
    ...
    private Model.Player self => GameMain.Instance.firstPerson.model;
    ...
    public void OnStartPlay()
    {
        ...
        {
            foreach (var i in handCards) i.gameObject.SetActive(i.name == "无懈可击");
            MoveAll(0);
        }
    ...
    public void OnClickCard(int cardId, bool value)
    {
        ...
        // if (!value) 
        Debug.Log(decision.cards.Count);
        if (inReset) return;
